...
public class VideoServletTech extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public VideoServletTech() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			System.out.println("categoryId>>>>>>>>>"+categoryId+"<<<<<<<<<<<currentPage"+currentPage);
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher(Constants.VIDEOTECH_PAGE);
