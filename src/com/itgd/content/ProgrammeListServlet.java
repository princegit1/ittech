	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(tokens.length>=Constants.FOUR) {
				...
				programmeCategoryId=Integer.parseInt(tempCategoryId);
			}
			request.setAttribute("programmeCategoryId",programmeCategoryId);
			request.setAttribute("currentProgrammeCategoryPageNo",currentPage);

			RequestDispatcher dispatcher = request.getRequestDispatcher(Constants.HLT_PROGRAMME_LIST);
