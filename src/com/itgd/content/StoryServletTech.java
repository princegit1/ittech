...
public class StoryServletTech extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public StoryServletTech() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher(Constants.STORY_PAGE_TECH);
	        dispatcher.forward(request, response);
		} catch(Exception ex) {
			System.out.println("StoryError"+pagePath);
