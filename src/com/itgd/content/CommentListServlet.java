	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if(tokens.length>Constants.TWO) {
				String tempContentType=tokens[Constants.TWO];
				if(tempContentType.equals("story") || tempContentType.equals("photo") || tempContentType.equals("video") || tempContentType.equals("all"))
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher(Constants.COMMENTLIST_PAGE);
