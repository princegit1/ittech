...
public class BlogServletTech extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public BlogServletTech() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String BlogUrl[]=dataUrl[dataUrlLen].split("\\.");
			BlogCategoryId=Integer.parseInt(BlogUrl[0]);
			...
			RequestDispatcher dispatcher = request.getRequestDispatcher("/blog_tech.jsp");
