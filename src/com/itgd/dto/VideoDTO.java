...
public class VideoDTO
{
    ...
    private String videoCreatedDateYYYMMDD;
    ...
    public String getVideoCreatedDateYYYMMDD()
    {
        return videoCreatedDateYYYMMDD;
    }

    public void setVideoCreatedDateYYYMMDD(String videoCreatedDateYYYMMDD)
    {
        this.videoCreatedDateYYYMMDD = videoCreatedDateYYYMMDD;
    }

	public int getMultibitrate_flag() {
		return multibitrate_flag;
	}

	public void setMultibitrate_flag(int multibitrateFlag) {
		multibitrate_flag = multibitrateFlag;
	}
}
