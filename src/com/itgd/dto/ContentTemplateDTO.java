...
public class ContentTemplateDTO {
	...
	private String crispyKicker;
	private int TotalContentCount;
	private String PrimaryCategoryTitle;
	private String mediumKickerImage;
	
	public String getMediumKickerImage() {
		return mediumKickerImage;
	}
	public void setMediumKickerImage(String mediumKickerImage) {
		this.mediumKickerImage = mediumKickerImage;
	}
	...
	public void setPrimaryCategoryTitle(String primaryCategoryTitle) {
		PrimaryCategoryTitle = primaryCategoryTitle;
	}
	...
	public String getCrispyKicker() {
		return crispyKicker;
	}
	public void setCrispyKicker(String crispyKicker) {
		this.crispyKicker = crispyKicker;
	}
	public int getId() {
		return id;
	}
